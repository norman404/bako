...
- Las ventas confirmadas se desglosan por Local, Uber Eats y DiDi; los deliveries además se desglosan por método (Efectivo y Pagado en app) en el corte. Los cobros en 0, como el pago de app, no se muestran en el reporte ni en el dashboard. El desglose por categoría incluye todos los canales: el total confirmado de cada pedido se reparte entre sus líneas proporcionalmente a los precios de catálogo, de modo que el bloque cuadra con el total vendido. El detalle por venta de un delivery mantiene solo productos y cantidades, sin importes de línea.
