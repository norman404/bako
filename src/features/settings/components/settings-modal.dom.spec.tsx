...
vi.mock("@/features/menu/components/admin/product-settings-panel", () => ({
...
vi.mock("@/features/menu/components/admin/category-settings-panel", () => ({
...
vi.mock("@/features/turno/components/turno-summary-panel", () => ({
  TurnoSummaryPanel: () => (
