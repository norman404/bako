import { LayoutDashboard, Menu, SearchX, Settings, X } from "lucide-react";
...
export function PosWorkspace({ onOpenAdmin, onOpenSettings }: PosWorkspaceProps) {
        ...
        >
          ...
          <div className="ml-auto flex items-center gap-1.5">
            ...
            >
              ...
              {t("headerActions.administration")}
            </Button>
