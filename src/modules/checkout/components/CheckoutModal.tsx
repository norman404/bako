  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="modal-shell-solid flex h-[calc(100dvh-1.5rem)] w-full max-w-[58rem] flex-col overflow-hidden rounded-modal animate-modal-in sm:h-[42rem] sm:max-h-[calc(100dvh-3rem)]">
