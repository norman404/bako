...
import enUsDelivery from "@/i18n/locales/en-US/delivery.json";
import enUsShift from "@/i18n/locales/en-US/shift.json";
import esArSettings from "@/i18n/locales/es-AR/settings.json";
import esArMenu from "@/i18n/locales/es-AR/menu.json";
import esArErrors from "@/i18n/locales/es-AR/errors.json";
import esArCheckout from "@/i18n/locales/es-AR/checkout.json";
import esArDelivery from "@/i18n/locales/es-AR/delivery.json";
import esArShift from "@/i18n/locales/es-AR/shift.json";
import esEsSettings from "@/i18n/locales/es-ES/settings.json";
import esEsMenu from "@/i18n/locales/es-ES/menu.json";
import esEsErrors from "@/i18n/locales/es-ES/errors.json";
import esEsCheckout from "@/i18n/locales/es-ES/checkout.json";
import esEsDelivery from "@/i18n/locales/es-ES/delivery.json";
import esEsShift from "@/i18n/locales/es-ES/shift.json";
import esMxSettings from "@/i18n/locales/es-MX/settings.json";
import esMxMenu from "@/i18n/locales/es-MX/menu.json";
import esMxErrors from "@/i18n/locales/es-MX/errors.json";
import esMxCheckout from "@/i18n/locales/es-MX/checkout.json";
import esMxDelivery from "@/i18n/locales/es-MX/delivery.json";
import esMxShift from "@/i18n/locales/es-MX/shift.json";
import ptBrSettings from "@/i18n/locales/pt-BR/settings.json";
import ptBrMenu from "@/i18n/locales/pt-BR/menu.json";
import ptBrErrors from "@/i18n/locales/pt-BR/errors.json";
import ptBrCheckout from "@/i18n/locales/pt-BR/checkout.json";
import ptBrDelivery from "@/i18n/locales/pt-BR/delivery.json";
import ptBrShift from "@/i18n/locales/pt-BR/shift.json";
